package com.example.playlistmaker.presentation.ui.playlist_viewer
...
import com.example.playlistmaker.databinding.FragmentPlaylistViewerBinding
...
import com.example.playlistmaker.presentation.view_models.PlaylistViewerViewModel
...
class PlaylistViewerFragment : Fragment() {
    ...
    private val viewModel by viewModel<PlaylistViewerViewModel>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.editPlaylist.setOnClickListener {
            findNavController().navigate(
                R.id.action_playlistViewerFragment_to_newPlaylistFragment,
                Bundle().apply {
    ...
    private fun renderUI(playlist: Playlist) {
        if (playlist.imagePath.isNullOrEmpty()) binding.playlistCover.setImageDrawable(
            getDrawable(
                requireContext(), R.drawable.placeholder
            )
        )
        else {
    ...
    private fun openPlayer(item: Track) {
        startActivity(AudioPlayerActivity.newInstance(requireContext(), item))
    }
